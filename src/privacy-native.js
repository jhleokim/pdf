(function(root){
 'use strict';
 let worker=null,workerURL=null,ready=null,pending=null,idleTimer,queue=Promise.resolve(),sequence=0,generation=0;
 function dispose(){generation++;clearTimeout(idleTimer);worker?.terminate();worker=null;ready=null;if(workerURL)URL.revokeObjectURL(workerURL);workerURL=null;}
