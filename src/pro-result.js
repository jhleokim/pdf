...
(function(root){
  ...
  function compressionOnly(o){
    return o.optimize&&!o.blackWhite&&!o.grayscale&&!o.contrast&&o.whitePoint===255&&!o.deskew&&!Object.values(o.deskewAngles||{}).some(angle=>Number.isFinite(angle)&&angle!==0)&&!o.crop&&o.paper==='original'&&!o.number&&!o.watermark&&!o.stamps?.length&&!o.ocr?.length;
  }
