...
The full automated suite passes 225 tests. Browser checks exercise both existing local OCR engines, source/cell selection, manual region creation, merge/undo, table copy, blocked unresolved-line exports, explicit cell retry acceptance/rejection, and retained edits when navigating a 50-record correction fixture. The latter is a navigation/persistence test, not a 50-page OCR benchmark.
