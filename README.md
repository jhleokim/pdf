...
현재 소스 버전: **v5.2.0**. 화면 우측 하단에서 확인할 수 있습니다. 이 문서는 빌드·운영 방법을 설명하며 배포 완료 기록은 아닙니다. [v5.2.0 변경·검증 기록](docs/release-v5.2.md)
...
| 배포·전달물 | `.deploy/index.html`과 `.deploy/ocr/` 자산, API Worker | `dist/PDF-Studio-Standalone-v5.2.0.html` 한 파일 |
