...
test('all HTML control ids are unique and application sources match embedded output',()=>{
  ...
  for(const name of ['editor','pro-engine','pro-document','pro-deskew','pro-pipeline','pro-rail','pro-result','pro-live-preview','pro-ui','pro-stamp','pro-ocr','pro-gemini','pro-gemini-ui','pro-tools-ui']){
