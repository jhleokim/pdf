(async()=>{
 ...
 try{
  ...
  const css=getComputedStyle($('textInput'));assert(css.fontStyle==='italic'&&css.textDecorationLine==='line-through'&&parseFloat(css.getPropertyValue('-webkit-text-stroke-width'))>0,'Input does not show emphasis');
