...
for(const [src,dst] of [
 ...
 ['experiments/ppocr-v5-browser/engine.js','engine.js'],['experiments/ppocr-v5-browser/worker.js','worker.js'],['experiments/ppocr-v5-browser/ui.js','ui.js'],['src/ocr-tables.js','ocr-tables.js'],['src/ocr-table-edit.js','ocr-table-edit.js'],['src/ocr-table-analysis.js','ocr-table-analysis.js'],['src/ocr-correction-lines.js','ocr-correction-lines.js'],['src/ocr-correction.js','ocr-correction.js']])fs.copyFileSync(new URL(src,root),new URL(dst,out));
