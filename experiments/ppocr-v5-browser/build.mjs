...
for(const [src,dst] of [
 ...
 ['experiments/ppocr-v5-browser/engine.js','engine.js'],['experiments/ppocr-v5-browser/worker.js','worker.js'],['experiments/ppocr-v5-browser/ui.js','ui.js'],['experiments/ppocr-v5-browser/index.html','index.html']])fs.copyFileSync(new URL(src,root),new URL(dst,out));
