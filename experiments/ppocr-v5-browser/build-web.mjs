...
const assets=['index.html','ui.js','ocr-tables.js','ocr-table-edit.js','ocr-table-analysis.js','ocr-correction-lines.js','ocr-correction.js','worker.js','engine.js','ort.js','opencv.js','pdfjs.js','pdf.worker.js','ort-wasm-simd-threaded.mjs','ort-wasm-simd-threaded.wasm','det.onnx','rec.onnx','dict.json'];
