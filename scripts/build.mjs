...
block('pro-runtime', ['work-progress.js','pro-tesseract-assets.js','pro-engine.js', 'pro-document.js', 'pro-stamp.js', 'pro-ocr.js', 'pro-gemini.js','pro-vision.js', 'pro-deskew.js', 'pro-pipeline.js', 'pro-result.js', 'pro-live-preview.js', 'pro-rail.js', 'pro-ui.js','ocr-correction.js','pro-tools-ui.js','pro-vision-unlock.js','pro-vision-ui.js'].filter(f=>!standalone||!f.startsWith('pro-gemini')&&!f.startsWith('pro-vision')&&f!=='pro-tesseract-assets.js').map(f => `<script id="${f.replace('.js','')}">\n${read('src/' + f)}\n</script>`).join('\n'), '</body>');
