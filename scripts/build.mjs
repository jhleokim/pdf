...
block('markup-assets',Object.entries({'markup-fontkit':'fontkit.umd.min.js','markup-font-gothic':'NanumGothic.ttf.zlib','markup-font-myeongjo':'NanumMyeongjo.ttf.zlib','markup-font-hana-regular':'Hana2-Regular.ttf.zlib','markup-font-hana-bold':'Hana2-Bold.ttf.zlib','ocr-search-font':'GlyphLessFont.ttf'}).map(([id,file])=>`<script type="application/octet-stream" id="${id}">${readFileSync(resolve(root,'vendor/markup',file)).toString('base64')}</script>`).join('\n'),'</body>');
